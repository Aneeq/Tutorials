...
{this._variableName=variableName;this._callbackFunction=callbackFunction;this._authHeaderCookieName=authHeaderCookieName;}
ContentFragmentContainerCustomCallback.prototype._getAuthValue=function(){var nameEQ=this._authHeaderCookieName+"=";var ca=document.cookie.split(';');for(var i=0;i<ca.length;i++){var c=ca[i];while(c.charAt(0)==' '){c=c.substring(1,c.length);}
